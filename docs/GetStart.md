...
2. Parse the results. Get the poly format results.
```shell 
python tools/TestJson2VocClassTxt.py --json_path 'runs/val/obb_demo4/best_obb_predictions.json' --save_path 'runs/val/obb_demo4/obb_predictions_Txt'
``` 
...
python DOTA_devkit-master/dota_evaluation_task1.py  --detpath 'runs/val/obb_demo_split4/obb_predictions_Txt/Task1_{:s}.txt'   --annopath 'dataset/DroneVehicle/test/labelTxt/{:s}.txt' --imagesetfile 'dataset/DroneVehicle/imgnamefile.txt'
