...
def parse_opt():
    ...
    parser.add_argument('--source1', type=str, default='/data/hexiao/yolov5_obb_tmm/dataset/dataset_tmm/rgb', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source2', type=str, default='/data/hexiao/yolov5_obb_tmm/dataset/dataset_tmm/ir', help='file/dir/URL/glob, 0 for webcam')
